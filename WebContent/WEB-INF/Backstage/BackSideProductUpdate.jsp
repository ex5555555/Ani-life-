...
<div class="main" style="width: 1500px;">
  ...
  <div class="inside" style="width: 1496px; height: 930px;" align="center">
	<h2>更改產品</h2>
	<hr style ="border：2px;">
	...
	<form action="bsUpdateProduct" method="post" enctype="multipart/form-data">
		...
		<textarea name="descripton" autocomplete="off" required id="descripton" style="width: 450px; height:300px; 
			max-width:450px; max-height:300px; color: #585858;" placeholder="descripton" class="insertbox">${product.descripton }
		</textarea>
		<br>
		<br>
		...
		<select name="classification" style="width: 194px;">
			...
			<option value="寵物用品" <c:if test="${product.classification == '寵物用品' }">selected='selected'</c:if>>寵物用品</option>
